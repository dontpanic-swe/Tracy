...
class UseCaseEventController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('UseCaseEvent');
	...
	{
		$model=new UseCaseEvent('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UseCaseEvent']))
			$model->attributes=$_GET['UseCaseEvent'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='use-case-event-form')
		{
