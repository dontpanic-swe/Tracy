...
class SourceController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        {
            $this->redirect(array('externalSource/view','id'=>$id));
        }
        else if ( isset($model->useCase)  )
        {
            $this->redirect(array('useCase/view','id'=>$id));
        }
        else
        {
            throw CHttpException(404,"Can't view orphaned source :^(");
        }
    }
    ...
    public function actionIndex()
    {
        ...
        $model = $model->with('externalSource','useCase');
