...
class ExternalSourceController extends Controller
{
    ...
    {
        $model=new ExternalSource('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['ExternalSource']))
            $model->attributes=$_GET['ExternalSource'];
    ...
    {
        $model=ExternalSource::model()->findByPk($id);
        if($model===null)
    ...
    {
        if(isset($_POST['ajax']) && $_POST['ajax']==='external-source-form')
        {
