...
$this->bg_image = null;
{
Yii::app()->clientscript->registerCss('snake',
<<<CSS
/*
JavaScript Snake
...
.snake-playing-field {
    ...
    padding: 0px;
    position: absolute;
    background: url(/logo/logo.gif) no-repeat scroll center center transparent;
...
{
Yii::app()->clientscript->registerScript('snake',
<<<JS
/*
JavaScript Snake
By Patrick Gillespie
    ...
    */
    ...
    return function(inputConfig) {
        ...
        var me = this,
            ...
            myKeyListener,
            // Board components
            elmContainer, elmPlayingField, elmLengthPanel, elmWelcome, elmTryAgain;
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "JavaScript Snake<p></p>You died NOOB.<p></p>";
...
Yii::app()->clientscript->registerScript('snake_lol','
