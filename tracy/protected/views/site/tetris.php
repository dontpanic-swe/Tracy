<?php
$this->bg_image = null;
Yii::app()->clientscript->registerCss('tetris',
'
body      { font-family: Helvetica, sans-serif; }
#tetris   { margin: 1em auto; padding: 1em; border: 4px solid black; border-radius: 10px; background-color: #F8F8F8; }
#stats    { display: inline-block; vertical-align: top; }
#canvas   { display: inline-block; vertical-align: top; background: url(/logo/logo.gif) no-repeat scroll center center transparent; box-shadow: 10px 10px 10px #999; border: 2px solid #333; }
